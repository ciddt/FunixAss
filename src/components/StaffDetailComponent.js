        ...
        <div className="container mb-3">
          ...
          <div className="row justify-content-center pr-lg-5">
            <div className="col-auto mr-lg-5">  
              <Button onClick={this.toggleModal} color="primary" className="mr-3">
            ...
            <Modal isOpen={this.state.isOpenModal} toggle={this.toggleModal}>
                <ModalHeader toggle={this.toggleModal} className="bg-primary text-white">Cập nhật thông tin Nhân viên</ModalHeader>
                <ModalBody>
